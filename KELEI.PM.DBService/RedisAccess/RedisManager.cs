...
namespace KELEI.PM.DBService.RedisAccess
{
    ...
    internal class RedisManager
    {
        ...
        /// </summary>
        internal static readonly int RedisDataBaseIndex = int.Parse(ConfigHelper.GetAppSetting(ConstSet.RedisDataBaseIndex) ?? "0");
        /// <summary>
        /// 当前连接的Redis中连接字符串，格式为：127.0.0.1:6379,allowadmin=true,passowrd=pwd
        /// </summary>
        internal static readonly string RedisHostConnection = ConfigHelper.GetAppSetting(ConstSet.RedisServer);
